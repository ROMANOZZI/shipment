        ...
        <table className='min-w-full divide-y divide-gray-200 shadow-xl rounded-lg'>
          <thead className='bg-header'>
            <tr className='text-2xl text-start text-grey border-b-2 border-grey'>
              <th className='px-0 lg:px-6 lg:py-3 py-2 text-left text-xs font-medium text-grey uppercase tracking-wider'>{t('Branch')}</th>
              <th className='px-0 lg:px-6 lg:py-3 py-2 text-left text-xs font-medium text-grey uppercase tracking-wider'>{t('Date')}</th>
              <th className='px-0  lg:px-6 lg:py-3 py-2 text-left text-xs font-medium text-grey uppercase tracking-wider'>{t('Time')}</th>
              <th className='lg:px-0 lg:py-3 py-2 text-left text-xs font-medium text-grey uppercase tracking-wider'>{t('Details')}</th>
            </tr>
          </thead>
          <tbody className='bg-white divide-y divide-gray-200'>
            {shipment?.TransitEvents.map((event, index) => (
              <tr key={index} className='text-2xl text-start text-grey border-b-2 border-grey'>
                ...
                <td className='lg:px-4 py-2 px-2  md:whitespace-nowrap text-sm text-black'>{t(`ShipmentStates.${event.state}`)}</td>
              </tr>
            ))}
          </tbody>
        </table>
